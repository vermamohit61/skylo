...
namespace Drupal\switch_theme_based_page\Form;
...
/**
   ...
   * {@inheritdoc}
   */
  public function __construct(ThemeHandlerInterface $theme_handler, ModuleHandlerInterface $module_handler, DomainLoader $domain_loader = NULL, LanguageManagerInterface $language_manager = NULL) {
  ...
  public static function create(ContainerInterface $container) {
    ...
    return new static(
      $container->get('theme_handler'),$container->get('module_handler'),
      $domainServices,
      $languageServices
    );
  ...
  public function getFormId() {
    return 'switch_theme_based_page_admin_settings';
  }
  ...
  protected function getEditableConfigNames() {
    return [
      'switch_theme_based_page.settings',
    ];
  }
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $config = $this->config('switch_theme_based_page.settings');
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->config('switch_theme_based_page.settings')
